...
public class MealController {
    ...
    public ResponseEntity<Meals> getMealsByPerson(@RequestBody Person person){
        Meals suggestedMeal = mealService.selectMealByPerson(person);
        return new ResponseEntity<>(suggestedMeal, HttpStatus.FOUND);
    }
